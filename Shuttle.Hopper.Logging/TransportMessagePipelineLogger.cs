...
public class TransportMessagePipelineLogger : IHostedService
{
    ...
    public TransportMessagePipelineLogger(ILogger<TransportMessagePipelineLogger> logger, IOptions<PipelineOptions> pipelineOptions, IServiceBusLoggingConfiguration serviceBusLoggingConfiguration)
    {
    ...
    private Task OnPipelineCreated(PipelineEventArgs eventArgs, CancellationToken cancellationToken)
    {
        ...
        {
            eventArgs.Pipeline.AddObserver(new TransportMessagePipelineObserver(_logger, _serviceBusLoggingConfiguration));
        }
